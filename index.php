...
$productsStmt = $pdo->query('SELECT id, kode_barang, nama_barang, kategori, harga_jual, stok FROM products ORDER BY nama_barang ASC');
...
<head>
    ...
    <style>
        ...
        .total-row { margin-bottom: 14px !important; }
        .mt-3 { margin-top: 10px !important; }

        /* ── Payment Amount compact ── */
        .payment-input-group { margin-bottom: 10px !important; }
        .input-lg { padding: 11px 14px !important; font-size: 15px !important; }
        ...
        .receipt-modal-overlay.active .receipt-modal { transform: scale(1) translateY(0); }
        ...
        .receipt-modal-header h3 { font-size: 18px; font-weight: 700; }
        ...
        .search-bar { width: 220px !important; }
        .search-bar input { padding: 10px 10px 10px 36px !important; font-size: 13px !important; }
        h1 { font-size: 20px !important; margin-bottom: 2px !important; }
        .products-section { padding: 20px 24px !important; }
        .categories-wrapper { margin-bottom: 16px !important; }
        .category-btn { padding: 6px 14px !important; font-size: 13px !important; }
        .header-tools {
            display: flex;
            align-items: center;
            gap: 10px;
        ...
        .product-image-placeholder { margin-bottom: 8px !important; }
    ...
    <aside class="cart-section">
        ...
        <div class="cart-summary">
            ...
            <div class="summary-row">
                ...
                <span class="font-medium text-emerald" id="discountAmount">- Rp 0</span>
            </div>
